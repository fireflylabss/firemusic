...
### Changed
- **Project Naming:** Renamed project from "msc" to "firemusic" as the primary directory name.
- **Brand Name:** Updated all documentation from "Fire Music" to "FireMusic" (single word).
- **Binary Aliases:** Maintained `msc` as a compatible alias alongside `firemusic` in Cargo.toml.
